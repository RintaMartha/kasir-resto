    ...
    <body>
        <center>
            ...
            <div class="menu">
               ...
               <pre><a href="login.php"><img src="img/adm.png" class="tbl2"> <a href="login.php"> <img src="img/aa.png" class="tbl2"> <a href="login.php"><img src="img/aaa.png" class="tbl2"> <a href="login.php"><img src="img/ceo.png" class="tbl2"></pre>
               <hr size="2px" width="90%" align="center" color="yellow">
                <button><p align="center"><a href="dashboard.php">LOGOUT</a></p></button>
                <br><br><br><br>
